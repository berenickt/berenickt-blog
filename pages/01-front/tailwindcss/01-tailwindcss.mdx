...
<section class="bg-neutral-700 flex flex-row justify-between items-center h-[250px] w-full group">
  ...
  <div class="flex flex-row justify-center items-center gap-3">
    <div
      class="w-32 h-32 bg-red-500 rounded-full border-2 border-black hover:bg-red-300 transition"
    ></div>
    <div
      class="w-32 h-32 bg-yellow-500 rounded-full border-2 border-black hover:bg-yellow-300 transition"
    ></div>
    <div
      class="w-32 h-32 bg-green-500 rounded-full border-2 border-black hover:bg-green-300 transition"
    ></div>
  </div>
